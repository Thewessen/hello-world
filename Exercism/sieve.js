...
//     take the next available unmarked number in your list (it is prime) mark
//     all the multiples of that number (they are not prime)
...
module.exports = function (number) {
  let primes = [...numbersTill(number)]
  for (let i = 0; i < primes.length; i += 1) {
    let multiples = [...multiplesOff(primes[i], number)]
