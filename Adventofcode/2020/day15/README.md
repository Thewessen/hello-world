...
turns reading from a list of _starting numbers_ (your puzzle input). Then, each
turn consists of considering the _most recently spoken number_:
...
either _`0`_ (if the last number is new) or an _age_ (if the last number is a
repeat).
